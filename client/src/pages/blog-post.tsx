...
export default function BlogPost() {
  ...
  const blogPosts = {
    ...
    "2": {
      ...
      image: "https://images.unsplash.com/photo-1531482615713-2afd69097998?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=600",
      readTime: "7 min read",
      content: `
    ...
    "3": {
      ...
      image: "https://images.unsplash.com/photo-1551650975-87deedd944c3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=600",
      readTime: "8 min read",
      content: `
    ...
    "6": {
      ...
      date: "2023-12-25",
      category: "SEO", 
      image: "https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=600",
      readTime: "9 min read",
      content: `
